...
from lib.common.myfile import *
from thirdparty_libs.colorama import *
from lib.common.terminalsize import get_terminal_size

if platform.system() == 'Windows':
    from thirdparty_libs.colorama.win32 import *
